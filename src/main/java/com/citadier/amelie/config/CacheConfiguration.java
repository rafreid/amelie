package com.citadier.amelie.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.citadier.amelie.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.citadier.amelie.repository.UserRepository.USERS_BY_EMAIL_CACHE);
